...
class SpendableSmile(SyncModel):
	user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="%(class)s_user")
	creator = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="%(class)s_creator")
	board = models.ForeignKey(Board, on_delete=models.SET_NULL, null=True)
	collected = models.BooleanField(default=False)
...
class Invite(models.Model):
	...
	invitee_firstname = models.CharField(max_length=128,null=True)
	invitee_lastname = models.CharField(max_length=128,null=True)
	invitee_email = models.CharField(max_length=256,null=True)
...
class TempProfileImage(models.Model):
	uuid = models.CharField(max_length=64,unique=True,null=True)
	created_date = models.DateTimeField(auto_now_add=True,null=True)
	updated_date = models.DateTimeField(auto_now=True,null=True)
